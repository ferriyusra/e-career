                        ...
                        <div class="mx-2 card-item position-relative w-100 h-100">
                            <div
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <h2 class="jobs-title text-capitalize text-center mt-2">{{$galeri->judul_kegiatan}}</h2>
                                        <p class="jobs-caption">
                                            {!! Str::limit($galeri->isi_kegiatan, 300) !!}
                                        </p>
                                        <div class="jobs-list">
                                ...
                                <a href="{{ route('detail-galeri', $galeri->slug )}}" class="btn btn-outline d-flex justify-content-center align-items-center w-100">
