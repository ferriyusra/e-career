...
@section('content')
   ...
   <div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Data Sosial Media Perusahaan</h1>
        <a href="{{ route('sosmed.create')}}" class="btn btn-sm btn-primary shadow-sm">
                    ...
                    <tbody>
                            @forelse ($items as $index => $item)
                                <tr>
                                    ...
                                    <td>{{ $item->url_sosial_media }}</td>
                                    <td>{{ $item->jenis_sosial_media }}</td>
                                    <td>
                                        <a href="{{route('sosmed.edit', $item->id)}}" class="btn btn-info">
