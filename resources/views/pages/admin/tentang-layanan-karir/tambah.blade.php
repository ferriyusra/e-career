...
@section('content')
   ...
   <div class="container-fluid">
    ...
    <div class="card-shadow">
        <div class="card-body">
            <form action="{{ route('tentang-layanan-karir.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="visi">Visi Layanan Karir</label>
                    <textarea name="visi" id="visi" class="form-control">{{old('visi')}}</textarea>
                    @error('visi')
                ...
                <div class="form-group">
                    ...
                    <textarea name="misi" id="misi" class="form-control">{{old('misi')}}</textarea>
                    @error('misi')
                         <div class="alert alert-danger">{{ $message }}</div>
                     @enderror
                </div>
