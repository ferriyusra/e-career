        ...
        <div class="card-body col-md-8">
            <form action="{{ route('kuisioner.store')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="soal_kuisioner" class="form-control" placeholder="Isi Soal...">{{old('soal_kuisioner')}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" name="tipe_soal" type="radio" id="pilihan_ganda" checked value=1>
                        @error('tipe_soal')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="tipe_soal" id="soal_essai" value=0 >
                        @error('tipe_soal')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                ...
                {{-- <div class="form-group">
                    ...
                    {{-- <div class="form-check">
                        <input class="form-check-input" name="jawaban_lain" type="radio" id="tidak_jawaban_lain" checked value=1 >
                        @error('jawaban_lain')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    ...
                    {{-- <div class="form-check">
                        <input class="form-check-input" type="radio" name="jawaban_lain" id="ada_jawaban_lain" value=0>
                        @error('jawaban_lain')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
