              ...
              <div class="row">
                  <div class="col-lg-9 pl-lg-0">
                      <div class="card card-details">
                          ...
                          <div class="row">
                              <div class="col-lg-6">
                                  <p class="jobs-title mt-2 mb-2 text-bold " style="margin: 28px;">
                                      Diiklankan sejak {{date('d-m-Y', strtotime($loker->pendaftaran_mulai))}}
                                  </p>
                              </div>
                              <div class="col-lg-6">
                                  <p class="jobs-title mt-2 mb-2 text-bold text-justify text-end"
                                      style="margin: 28px;">
                  ...
                  <div class="col-lg-3">
                      ...
                      @foreach ($lokerLain as $loker)
                        <div class="card card-details mb-3">
                            <img src="{{Storage::url($loker->lokerPerusahaan->gambar)}}" alt="{{$loker->lokerPerusahaan->nama_perusahaan}}" class="img-fluid rounded-circle" style="width: 60px; height: 60px;">
                            <h1 class="jobs-title text-capitalize">{{$loker->posisi_lowongan}}</h1>
                            <hr>
                            <p class="jobs-title mt-2 mb-2 text-bold text-capitalize"> <i class="fas fa-building"></i> {{$loker->lokerPerusahaan->nama_perusahaan}}
                                <br>
                                <i class="fas fa-map-signs"></i> {{$loker->lokasi_detail_lowongan}}
                            </p>
                            <p class="jobs-title text-bold mt-2"> <i class="fas fa-dollar-sign"></i>
                                IDR {{ number_format($loker->rentang_gaji_min, 0, '.', '.') }} - {{ number_format($loker->rentang_gaji_max, 0, '.', '.') }}
                            </p>
                            <a href="{{route('detail-lowongan', $loker->slug)}}" class="see-all-jobs">Lihat Lowongan</a>
                        </div>
                      @endforeach
                          ...
                          <div class="col-lg-9 mt-3">
                              <div class="card card-details">
                                  <div class="card-horizontal">
                                      ...
                                      <div class="card-body">
                                          <h1 class="jobs-title text-capitalize">{{$loker->lokerPerusahaan->nama_perusahaan}}</h1>
                                          <p class="jobs-title mt-2 mb-2 text-bold text-justify">
