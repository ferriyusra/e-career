    ...
    <section>
        <div class="content-3-7 overflow-hidden container-xxl mx-auto position-relative"
            ...
            <div class="mx-auto">
                ...
                @if ($filterLoker->isNotEmpty())

                @foreach ($filterLoker as $loker)
                <div class="col">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="jobs-list">
                                        ...
                                        <p class="d-flex align-items-center check">
                                            <span
                                                class="span-icon d-inline-flex align-items-center justify-content-center flex-shrink-0">
                                                <i class="fas fa-briefcase"></i> </span>Tanggal Terbit Lowongan
                ...
                <div class="col-lg-12">
                    <div class="mx-2 card-item position-relative w-100 h-100">
                        <div
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <h2 class="jobs-title text-capitalize text-center">Posisi Lowongan Tidak Ditemukan</h2>
                                </div>
                            </div>
                        </div>
                    </div>
