                            ...
                            <div class="row">
                                ...
                                <div class="jobs-list mt-4">
                                    ...
                                    <div class="d-flex w-100 div-input-more mt-4">
                                        <input class="input-field-more border-0" name="jawaban_mahasiswa[{{$key}}]" type="text" required/>
                                    </div>
                                ...
                                @foreach ($jawaban as $jwb)
                                    <div class="jobs-list mt-4">
                                        <div>
                                            <label>
                                                <input type="radio" class="option-input radio" name="jawaban_mahasiswa[{{$key}}]" 
                                                value="{{$jwb}}"
                                                required
                                                />
                                                {{$jwb}}
