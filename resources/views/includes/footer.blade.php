  <!-- footer -->
  <footer class="footer-4-1 border-top mt-4" style="font-family: 'Inter', sans-serif;">
    <div class="container-xxl mx-auto main">
        <div class="d-flex flex-lg-row flex-column" style="margin-bottom: 5rem">
            <div class="left-col mb-lg-0 mb-5">
                ...
                <h5 class="caption-font">
                    ...
                    Gandaria Utara, <br class="d-md-block d-none"> Kec. Kby. Baru, Kota Jakarta Selatan, .<br
                        class="d-md-block d-none">Daerah
            ...
            <div class="right-col">
                <div class="d-flex row gap-lg-0 gap-4">
                    <div class="col-lg-4">
                        <h5 class="title-font">Hubungi</h5>
                        <nav class="list-unstyled list-footer d-grid gap-3">
                            <li class="text-base">
                                <a href="#" class="text-decoration-none">(021) 739 7973</a>
                            </li>
                        </nav>
                    </div>
                    <div class="col-lg-4">
                        <h5 class="title-font">Menu Lain</h5>
                        <nav class="list-unstyled list-footer d-grid gap-3">
                            <li class="text-base">
                                <a href="{{route('home')}}" class="text-decoration-none">Layanan Karir</a>
                            </li>
                            <li class="text-base">
                                <a href="{{route('galeri-kegiatan')}}" class="text-decoration-none">Kegiatan</a>
                            </li>
                            <li class="text-base">
                                <a href="{{route('tidak-ada-halaman')}}" class="text-decoration-none">Seputar Pertanyaan</a>
                            </li>
                        </nav>
                    </div>
                    <div class="col-lg-4">
                        <div>
                            <h5 class="title-font">Ikuti Sosial Media</h5>
        ...
        <div class="">
            <div
                ...
                <nav class="text-base text-start" style="color: #112340;">
                ...
                <div class="d-flex gap-4">
                    ...
                    <a class="footer-link text-base text-start text-decoration-none" href="{{route('semua-lowongan')}}">Lowongan Pekerjaan</a>
                </div>
            </div>
        </div>
    </div>
